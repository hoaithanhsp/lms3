...
const Reports = () => {
  ...
  const handleGenerateReport = () => {
    ...
    setTimeout(() => {
      ...
      alert('Tải dữ liệu báo cáo thành công!');
    }, 1500);
  };
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex flex-col md:flex-row gap-4">
          ...
          <button
            ...
            className={`px-6 py-2 rounded-lg font-bold text-white transition-colors shadow-lg ${isGenerating ? 'bg-blue-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 shadow-blue-200'
              }`}
          >
            {isGenerating ? 'Đang tải...' : 'Xem báo cáo'}
          </button>
        </div>
      </div>
