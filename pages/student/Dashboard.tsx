      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 space-y-8">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             <div className="bg-blue-50 p-6 rounded-3xl border-2 border-blue-100 hover:border-blue-300 hover:shadow-lg transition-all cursor-pointer group">
             ...
             <div className="bg-green-50 p-6 rounded-3xl border-2 border-green-100 hover:border-green-300 hover:shadow-lg transition-all cursor-pointer group">
             ...
             <div className="bg-purple-50 p-6 rounded-3xl border-2 border-purple-100 hover:border-purple-300 hover:shadow-lg transition-all cursor-pointer group">
